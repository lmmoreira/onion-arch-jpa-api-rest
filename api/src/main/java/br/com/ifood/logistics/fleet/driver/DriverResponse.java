...
class DriverResponse {
    ...
    private final Set<DriverAttributeResponse> attributes;

    @JsonCreator
    public DriverResponse(@JsonProperty("uuid") final UUID uuid,
                          ...
                          @JsonProperty("attributes") final Set<DriverAttributeResponse> attributes) {
        this.uuid = uuid;
